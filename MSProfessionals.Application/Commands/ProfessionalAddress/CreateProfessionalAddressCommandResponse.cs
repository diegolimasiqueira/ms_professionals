...
/// <summary>
/// Response for the CreateProfessionalAddressCommand
/// </summary>
public class CreateProfessionalAddressCommandResponse
{
    /// <summary>
    ...
    public CreateProfessionalAddressCommandResponse(Domain.Entities.ProfessionalAddress professionalAddress)
    {
