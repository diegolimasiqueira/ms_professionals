...
/// <summary>
/// Response for the GetProfessionalAddressByIdCommand
/// </summary>
public class GetProfessionalAddressByIdCommandResponse
{
    /// <summary>
    ...
    public GetProfessionalAddressByIdCommandResponse(Domain.Entities.ProfessionalAddress professionalAddress)
    {
