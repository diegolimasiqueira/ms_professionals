...
/// <summary>
/// Response for the UpdateProfessionalCommand
/// </summary>
public class UpdateProfessionalCommandResponse
{
    /// <summary>
    /// Professional ID
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the UpdateProfessionalCommandResponse
    /// </summary>
    /// <param name="professional">Professional entity</param>
    public UpdateProfessionalCommandResponse(Domain.Entities.Professional professional)
    {
        Id = professional.Id;
