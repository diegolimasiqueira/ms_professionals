...
/// <summary>
/// Response for the GetProfessionalByNameCommand
/// </summary>
public class GetProfessionalByNameCommandResponse
{
    /// <summary>
    /// Professional ID
    /// </summary>
    ...
    public GetProfessionalByNameCommandResponse(Domain.Entities.Professional professional)
    {
        Id = professional.Id;
